...
export default function Footer() {
    ...
    // console.log(authContext?.informationCo[0])
    return (
                ...
                <div className="item-footer">
                    <div className='contact-us-wrapper first-footer'>
                        <div className='contact-us-item d-flex align-items-start' >
                            ...
                            <div className='contact-item-text'>ادرس : {authContext?.informationCo[0]?.address} </div>
                        </div>
                ...
                <div className="item-footer">
                    <div className='contact-us-wrapper'>
                        <div className='contact-us-item'>
                            ...
                            <div className='contact-item-text'> {authContext?.informationCo[0]?.phone}</div>
                        </div>
                        <div className='contact-us-item'>
                            <div className='contact-item-icon'><EmailOutlinedIcon /></div>
                            <div className='contact-item-text'>{authContext?.informationCo[0]?.email}</div>
                        </div>
                    </div>
                </div>
                <div className="item-footer">
