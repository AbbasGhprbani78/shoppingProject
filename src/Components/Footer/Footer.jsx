    ...
    return (
        <div className='footer-container'>
            <div className="item-footer">
                ...
                <Link className='more-btn-footer'>بیشتر</Link>
            </div>
            <div className="item-footer">
                <p className='title-footer'>درباره ما</p>
            ...
            <div className="item-footer">
                ...
                <div className="aboutus-input-wrapper">
                    ...
                    <button className='btn-inputus'>کلیک</button>
                </div>
                ...
                <div className="btns-wrapper-footer">
                    <button className="btn-left-footer"><span className='system-icon'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-android2" viewBox="0 0 16 16">
                    ...
                    <button className="btn-left-footer"><span className='system-icon'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-apple" viewBox="0 0 16 16">
